...
import{PREMIERCONTACT_UPDATE_RESET } from '../constants/Premiercontact';
import {updatePremiercontact,
  listPremiercontactDetails
...
const dispatch = useDispatch()
  ...
  const premiercontactDetails = useSelector((state) => state.premiercontactDetails)

  const { loading, error, premiercontact } = premiercontactDetails

 
 
      
  const premiercontactUpdate = useSelector((state) => state.premiercontactUpdate)
  const {
    loading: loadingUpdate,
    error: errorUpdate,
    success: successUpdate,
  } = premiercontactUpdate
  ...
  const [startDate, setStartDate] = useState(new Date());
                ...
                const handleNameChangeemail = event => {
                  setEmail(event.target.value); }
                    const handleNameChangetelp = event => {
                      ...
                      useEffect(() => {
                        if (successUpdate) {
                          dispatch({ type: PREMIERCONTACT_UPDATE_RESET })
                          history('/premiercontactlist')
                        } 
                                           
                      else{ 
                      if (!premiercontact.nomp || premiercontact._id !== id)
                            {dispatch(listPremiercontactDetails(id))
                        }          
                               
                        else {
                          setNomp(premiercontact.nomp)
                          setEmail(premiercontact.email)
                          setP_A(premiercontact.P_A)
                          setPermis(premiercontact.permis)
                          setP_P(premiercontact.P_P) 
                          setP_N_P(premiercontact.P_N_P)  
                         setD_Q_R(premiercontact.D_Q_R)
                          setNouv(premiercontact.nouv)  
                        setV_P_I(premiercontact.V_P_I) 
                          setC_T_M(premiercontact.C_T_M)
                          setT_P(premiercontact.T_P)
                          setT_S(premiercontact.T_S) 
                          setS_A_R(premiercontact.S_A_R) 
                          setF_A(premiercontact.F_A)
                          setE_C(premiercontact.E_C)
                          setT_P_M(premiercontact.T_P_M)
                          setC_C(premiercontact.C_C )
                          setD_M(premiercontact.D_M) 
                          setP_S_D(premiercontact.P_S_D) 
                          setA_V_D(premiercontact.A_V_D) 
                          setA_F(premiercontact.A_F) 
                          setE_V_P(premiercontact.E_V_P) 
                          setV_V(premiercontact.V_V) 
                         setSal(premiercontact.Sal) 
                          setP_S(premiercontact.P_S) 
                          setS_M(premiercontact.S_M)
                          setC_S_L(premiercontact.C_S_L) 
                          setD_S1(premiercontact.D_S1)
                          setD_S2(premiercontact.D_S2)  
                          setD_S3(premiercontact.D_S3) 
                          setD_S4(premiercontact.D_S4) 
                          setP_N(premiercontact.P_N) 
                          setD_E(premiercontact.D_E) 
                         setE_A(premiercontact.E_A) 
                          setNomp(premiercontact.nomp)
                          setAdresse(premiercontact.adresse) 
                          setSite(premiercontact.site)
                           setPermis(premiercontact.permis) 
                          setTelf(premiercontact.telf) 
                          setTelp(premiercontact.telp) 
                         setEmail(premiercontact.email)
                         setValue(premiercontact.value)
                         setValue2(premiercontact.value2)
                        //console.log(value)
                       //  console.log(value2)
                        }
                      }   }
                      
                      , [dispatch, history, id, premiercontact, successUpdate])
   ...
   return (
    <>
    <Link to='/premiercontactlist' className='btn btn-light my-3'>
        Go Back
      </Link>
